...
function cal_popup (str_datetime) {
    ...
    // Specify the base directory only on the first instance of the calendar window.
    var base;
    if (str_datetime == null) {
        base = 'handlers/resources/calendar/';
    } else {
        base = '';
    }

    var obj_calwindow = window.open(
        base+'calendar.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
